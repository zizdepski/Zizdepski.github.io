...
function greeter(hour) {
    ...
    /* use if statement to print messages that are dependent on the range that 
    hour falls in. Use else at the end as a default for any values not addressed
    in the previous ef/else statements. */
    if (hour <= 11) {
